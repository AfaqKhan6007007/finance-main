// components/pages/journal-entries/KanbanCreateModal.tsx
...
export default function KanbanCreateModal({ handleShowKanbanBoard, onKanbanBoardAdded }: KanbanCreateModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('/api/user/kanbanView/journal-entries', formData);
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <SelectContent className="min-w-[var(--radix-select-trigger-width)]">
                                <SelectItem value="voucher_type" className="h-12 px-4 text-base flex items-center">
                                    Voucher Type
                                </SelectItem>
                                <SelectItem value="company" className="h-12 px-4 text-base flex items-center">
                                    Company
                                </SelectItem>
                                <SelectItem value="is_opening" className="h-12 px-4 text-base flex items-center">
                                    Is Opening
                                </SelectItem>
                                <SelectItem value="multi_currency" className="h-12 px-4 text-base flex items-center">
                                    Multi Currency
                                </SelectItem>
                            </SelectContent>
                        </Select>
